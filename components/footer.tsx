export default function Footer() {
    return (
        <>
            ...
            <footer className="flex flex-col bg-slate-50 items-center justify-around w-full py-16 text-sm ">
                <div className="flex items-center gap-8 font-bold text-4xl">
                 <h1>MILLAN</h1>
                </div>
                ...
                <p className="mt-8 text-center">Copyright © 2025 <a href="#">Mittee</a>. All rights reservered.</p>
            </footer>
        </>
    );
};